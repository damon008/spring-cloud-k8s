...
public class EnvConfig {
    ...
    private String jdbc_url = "jdbc:mysql://localhost:3306/xxx?zeroDateTimeBehavior=convertToNull&amp;useUnicode=true&amp;characterEncoding=utf-8&amp;useSSL=false";
    private String jdbc_username = "root";
    private String jdbc_password = "swsw";
	...
	public String getAdmin_web_url() {
		return admin_web_url;
	}

	public void setAdmin_web_url(String admin_web_url) {
