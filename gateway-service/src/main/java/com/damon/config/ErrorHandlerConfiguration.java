...
import com.damon.handler.MyExceptionHandler;
...
public class ErrorHandlerConfiguration {
	...
	public ErrorWebExceptionHandler errorWebExceptionHandler(ErrorAttributes errorAttributes) {
		MyExceptionHandler exceptionHandler = new MyExceptionHandler(errorAttributes, this.resourceProperties,
